...
object CameraFrameUtils {
    ...
    fun fromImageProxy(imageProxy: ImageProxy, backCamera: Boolean): Bitmap? {
        ...
        val bitmap = FaceLivenessSDK.yuv2Bitmap(nv21, image.width, image.height, mode) ?: return null
    ...
    /** Same downscale as FaceLivenessSDK bitmapToRgb (long side ≤ 1280) for gallery crop coords. */
